...
/**
 * @var array $package_permissions  Array of permissions assigned to the package
 * @var array $all_permissions      Array of all permissions, grouped by parent
 * @var string $org_name            Name of the organization
 * @var string $org_slug            Slug of the organization
 * @var int $packageId             ID of the package
 * @var callable $createTabs       Function to create the settings tabs
 */
...
<div class="grid grid-cols-1 py-6">
    ...
    <?= package_permissions_settings_tabs('package_permissions', $org_slug, $packageId, ['group_id' => 'new']); ?>
        ...
        <div class="py-6 mb-6">
            <div class="flex justify-between items-start">
                ...
                <div class="flex flex-col space-y-2">
                    <!--                    <a href="--><?php //= route_to('package-settings', $org_slug) ?><!--"-->
