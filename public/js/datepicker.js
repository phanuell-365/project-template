  ...
  class DaysView extends View {
    ...
    refresh() {
      ...
      this.grid
        ...
        .forEach((el) => {
          el.classList.remove('range', 'range-start', 'range-end', 'selected', 'bg-soko-700', 'text-white', 'dark:bg-soko-600', 'dark:text-white', 'focused');
  ...
  class MonthsView extends View {
    ...
    refresh() {
      ...
      this.grid
        .querySelectorAll('.range, .range-start, .range-end, .selected, .focused')
        .forEach((el) => {
          el.classList.remove('range', 'range-start', 'range-end', 'selected', 'bg-soko-700', 'dark:bg-soko-600', 'dark:text-white', 'text-white', 'focused');
